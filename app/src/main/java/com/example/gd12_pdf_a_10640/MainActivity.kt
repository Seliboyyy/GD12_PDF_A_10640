package com.example.gd12_pdf_a_10640
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String) {
        ...
        @SuppressLint("UseCompatLoadingForDrawables") val d = getDrawable(R.drawable.matahari)
        ...
        val namapengguna = Paragraph("Identitas Pengguna").setBold().setFontSize(12f)
        ...
        table.addCell(Cell().add(Paragraph(LocalDate.now().format(timeFormatter))))
        ...
        val barcodeQRCode = BarcodeQRCode(
            ...
            ${LocalDate.now().format(timeFormatter)}
